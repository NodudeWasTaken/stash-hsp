...
function findProjectionTagsFromFilename(processedScene: HeresphereVideoEntry, filename: string): void {
	...
	if (path.includes("_F180") || path.includes("_180F") || path.includes("_VR180")) {
		processedScene.projection = HeresphereProjectionFisheye;
